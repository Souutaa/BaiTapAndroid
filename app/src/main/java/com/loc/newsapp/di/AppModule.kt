...
import com.loc.newsapp.domain.usecases.news.GetNewsFromUrl
...
import com.loc.newsapp.util.Constants.NEW_DATABASE_NAME
...
object AppModule {
    ...
    fun provideNewsUseCases(
        ...
        return NewsUseCases(
            ...
            getNewsFromUrl = GetNewsFromUrl(newsRepository)
        )
    }
